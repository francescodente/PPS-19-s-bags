 ...
 */
class CliView[B <: RectangularStructure, G](override val renderers: Seq[CliRenderer[G]], parser: CliEventParser)
...
object CliView {
  def apply[B <: RectangularStructure, G](renderers: Seq[CliRenderer[G]], parser: CliEventParser)(implicit ev: BoardState[B, G]): CliView[B, G] =
