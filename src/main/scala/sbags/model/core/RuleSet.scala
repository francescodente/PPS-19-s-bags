...
trait RuleSet[M, G] {
  /**
   * Returns true if the given move is valid for the given state.
   *
  ...
  /**
   * Returns a sequence of all possible moves for the given state.
   *
  ...
  /**
   * Executes a move on the given state.
   *
